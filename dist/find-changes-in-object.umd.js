(function (global, factory) {
  ...
  function findChangesInObject(a, b) {
    ...
    var keysBNotInA = without_1.apply(void 0, [keysB].concat(_toConsumableArray(keysA)));
    var keysANotInB = without_1.apply(void 0, [keysA].concat(_toConsumableArray(keysB)));
    var keysInBoth = intersection_1(keysA, keysB);
    var keysAdded = {};
    ...
    try {
      for (var _iterator3 = keysInBoth[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
        ...
        } else if (isPlainObject_1(a[_key2])) {
          var changes = findChangesInObject(a[_key2], b[_key2]);

          if (!isEmpty_1(changes)) {
            keysUpdated[_key2] = changes;
          }
        } else if (!isEqual_1(a[_key2], b[_key2])) {
          keysUpdated[_key2] = b[_key2];
        }
      }
    } catch (err) {
